...
def main(cfg, videoID=None, threshold=0.8):
    cfg = Config.fromfile(cfg)
    # print(videoID)
    if videoID is not None:
      # print(cfg.data_root, videoID)
      cfg.data_root = cfg.data_root + videoID
      # print(cfg.data_root)
      cfg.shot_frm_path = cfg.data_root + "/shot_txt"  
      # print(cfg.shot_frm_path)
    os.environ["CUDA_VISIBLE_DEVICES"] = cfg.gpus
    ...
    if cfg.testFlag:
        ...
        if cfg.dataset.name == "demo":
            ...
            scene_dict, scene_list = pred2scene(cfg, threshold=threshold)
